...
#comando="gfortran -c ../src/nrtype.f90"; eval $comando
#comando="gfortran -c ../src/nrutil.f90"; eval $comando
#comando="gfortran -c ../src/ran_state.f90"; eval $comando
#comando="gfortran -c ../src/ranrecipies.f90"; eval $comando
